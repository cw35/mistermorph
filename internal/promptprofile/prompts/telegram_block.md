...
- Use @username to mention someone if you can find their username from the message history or [Group Usernames]. For example, [Nickname](tg:@username); don't invent username.
